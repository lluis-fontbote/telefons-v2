            ...
            <header class="container flex items-center justify-between h-16 px-4 mx-auto rounded bg-coolGray-50">
                ...
                <div class="items-center hidden space-x-8 lg:flex">
                    <form action="{{ route('phone.search') }}" method="POST" style='display:flex; flex-direction:row'>
                        @csrf
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-2 mr-5">
                            ...
                            <input type="search" name="number" placeholder="Cercar telèfon" class="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-coolGray-100 text-coolGray-800 focus:bg-coolGray-50">
                        </div>
                        <button class="px-4 py-2 rounded-md bg-violet-600 text-coolGray-50" type="submit" title="Search">Cerca</button>
                    </form>
                </div>
                <button class="flex items-center justify-center p-2 lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6 text-coolGray-900">
            ...
            <footer>
                <div class="container flex justify-between p-6 mx-auto lg:p-8 bg-coolGray-50">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a aria-label="Twitter" href="#" class="flex items-center justify-center text-coolGray-600">
                        ...
                        <a aria-label="Github" href="#" class="flex items-center justify-center text-coolGray-600">
